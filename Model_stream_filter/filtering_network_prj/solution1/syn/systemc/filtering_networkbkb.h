...
// ==============================================================
#ifndef __filtering_networkbkb__HH__
#define __filtering_networkbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(filtering_networkbkb) {
    ...
    SC_CTOR(filtering_networkbkb):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
