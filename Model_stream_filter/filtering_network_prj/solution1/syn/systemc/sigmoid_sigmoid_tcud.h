...
// ==============================================================
#ifndef __sigmoid_sigmoid_tcud_H__
#define __sigmoid_sigmoid_tcud_H__
...
struct sigmoid_sigmoid_tcud_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(sigmoid_sigmoid_tcud_ram) {
...
SC_MODULE(sigmoid_sigmoid_tcud) {
...
sigmoid_sigmoid_tcud_ram* meminst;


SC_CTOR(sigmoid_sigmoid_tcud) {
meminst = new sigmoid_sigmoid_tcud_ram("sigmoid_sigmoid_tcud_ram");
