...
// ==============================================================
#ifndef __disambiguation_nedEe__HH__
#define __disambiguation_nedEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(disambiguation_nedEe) {
    ...
    SC_CTOR(disambiguation_nedEe):  ACMP_smul_su_U ("ACMP_smul_su_U") {
