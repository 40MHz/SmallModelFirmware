...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module disambiguation_nebkb_rom (
...
initial begin
    $readmemh("./disambiguation_nebkb_rom.dat", ram0);
    $readmemh("./disambiguation_nebkb_rom.dat", ram1);
    $readmemh("./disambiguation_nebkb_rom.dat", ram2);
    $readmemh("./disambiguation_nebkb_rom.dat", ram3);
    $readmemh("./disambiguation_nebkb_rom.dat", ram4);
    $readmemh("./disambiguation_nebkb_rom.dat", ram5);
end
...
disambiguation_nebkb_rom disambiguation_nebkb_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
