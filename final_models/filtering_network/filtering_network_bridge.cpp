#ifndef FILTERING_NETWORK_BRIDGE_H_
#define FILTERING_NETWORK_BRIDGE_H_

#include "firmware/filtering_network.h"
...
void allocate_trace_storage(size_t element_size) {
    ...
    nnet::trace_outputs->insert(std::pair<std::string, void *>("sigmoid_activation", (void *) malloc(N_LAYER_5 * element_size)));
}
...
void filtering_network_float(
    ...
    filtering_network(input_ap, layer7_out_ap, const_size_in_1, const_size_out_1);

    nnet::convert_data<result_t, float, N_LAYER_5>(layer7_out_ap, layer7_out);
}

void filtering_network_double(
