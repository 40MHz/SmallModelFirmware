...
// ==============================================================
#ifndef __sigmoid_sigmoid_tbkb_H__
#define __sigmoid_sigmoid_tbkb_H__
...
struct sigmoid_sigmoid_tbkb_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(sigmoid_sigmoid_tbkb_ram) {
...
SC_MODULE(sigmoid_sigmoid_tbkb) {
...
sigmoid_sigmoid_tbkb_ram* meminst;


SC_CTOR(sigmoid_sigmoid_tbkb) {
meminst = new sigmoid_sigmoid_tbkb_ram("sigmoid_sigmoid_tbkb_ram");
