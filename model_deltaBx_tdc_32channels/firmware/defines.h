...
typedef ap_fixed<7,1,AP_RND,AP_SAT> layer8_t;
typedef ap_fixed<16,6> layer9_t;
typedef ap_fixed<7,1> weight9_t;
typedef ap_fixed<7,1> bias9_t;
typedef ap_fixed<7,1,AP_RND,AP_SAT> layer11_t;
typedef ap_fixed<16,6> layer12_t;
typedef ap_fixed<7,1> weight12_t;
typedef ap_fixed<7,1> bias12_t;
typedef ap_fixed<7,2,AP_RND,AP_SAT> result_t;
