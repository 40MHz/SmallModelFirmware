...
void myproject(
    ...
    #pragma HLS INTERFACE ap_vld port=input,layer14_out 
    #pragma HLS PIPELINE 
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt<weight9_t, 512>(w9, "w9.txt");
    ...
    nnet::linear<layer12_t, result_t, linear_config14>(layer12_out, layer14_out);
