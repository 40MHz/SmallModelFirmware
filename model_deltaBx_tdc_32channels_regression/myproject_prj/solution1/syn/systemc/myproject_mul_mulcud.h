...
// ==============================================================
#ifndef __myproject_mul_mulcud__HH__
#define __myproject_mul_mulcud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_mul_mulcud) {
    ...
    SC_CTOR(myproject_mul_mulcud):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
