...
// ==============================================================
#ifndef __myproject_mul_muldEe__HH__
#define __myproject_mul_muldEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_mul_muldEe) {
    ...
    SC_CTOR(myproject_mul_muldEe):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
