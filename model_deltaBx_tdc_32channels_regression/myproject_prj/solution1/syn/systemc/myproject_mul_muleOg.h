...
// ==============================================================
#ifndef __myproject_mul_muleOg__HH__
#define __myproject_mul_muleOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_mul_muleOg) {
    ...
    SC_CTOR(myproject_mul_muleOg):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
