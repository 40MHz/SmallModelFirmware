...
const sc_lv<32> product_1::ap_const_lv32_6 = "110";
const sc_lv<32> product_1::ap_const_lv32_15 = "10101";
const sc_logic product_1::ap_const_logic_0 = sc_dt::Log_0;

product_1::product_1(sc_module_name name) : sc_module(name), mVcdFile(0) {
    filtering_networkbkb_U2 = new filtering_networkbkb<1,1,16,7,22>("filtering_networkbkb_U2");
...
void product_1::thread_ap_return() {
    ap_return = r_V_fu_43_p2.read().range(21, 6);
}
