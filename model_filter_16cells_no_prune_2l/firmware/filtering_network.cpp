...
void filtering_network(
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt<bn1_scale_t, 16>(s2, "s2.txt");
        nnet::load_weights_from_txt<bn1_bias_t, 16>(b2, "b2.txt");
        nnet::load_weights_from_txt<weight3_t, 400>(w3, "w3.txt");
        nnet::load_weights_from_txt<bias3_t, 25>(b3, "b3.txt");
        nnet::load_weights_from_txt<weight6_t, 500>(w6, "w6.txt");
        nnet::load_weights_from_txt<bias6_t, 20>(b6, "b6.txt");
        nnet::load_weights_from_txt<weight9_t, 320>(w9, "w9.txt");
    ...
    nnet::sigmoid<layer9_t, result_t, sigmoid_config11>(layer9_out, layer11_out);
